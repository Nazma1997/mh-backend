...
exports.CurrentHiredEmployeeSchema = void 0;
...
exports.CurrentHiredEmployeeSchema = new mongoose_1.default.Schema({
    employeeId: {
        type: mongoose_1.default.Types.ObjectId,
        required: true,
    },
...
const CurrentHiredEmployee = mongoose_1.default.model("current-hired-employees", exports.CurrentHiredEmployeeSchema);
exports.default = CurrentHiredEmployee;
