...
export interface CurrentHiredEmployeeDocument {
...
export const CurrentHiredEmployeeSchema = new mongoose.Schema(
    {
        employeeId: {
            type: mongoose.Types.ObjectId,
            required: true,
...
const CurrentHiredEmployee = mongoose.model<CurrentHiredEmployeeDocument>("current-hired-employees", CurrentHiredEmployeeSchema);

export default CurrentHiredEmployee;