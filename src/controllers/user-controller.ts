...
import {
    createUser, createMhUser, updateMhUser, login, forgotPassword, resetPassword, getToken, updateUser,
    updateUserCertificateInfo, removeUserInfo, getUserList, getUserListForDropDown, getMhEmployeeUserList,
    getUserInfoById, removeEmployeeCertificateInfo, updateUserPushNotificationInfo
...
import { multipleImageOrFileUnlink, imageOrFileUnlink } from "../services/aws-s3-service";
...
export const getAll = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "User list fetch successfully!", null, user);
    } catch (err) {
        return next(err);
    }
};
...
export const getAllPublic = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
...
//pass to the valid request to service
export const getAllMhEmployee = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
...
export const getInfo = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        if (user && user.menuPermission && user.menuPermission.position) menuPermission.push("POSITION");
        if (user && user.menuPermission && user.menuPermission.skill) menuPermission.push("SKILL");
        if (user && user.menuPermission && user.menuPermission.source) menuPermission.push("SOURCE");
        if (user && user.menuPermission && user.menuPermission.employeeList) menuPermission.push("EMPLOYEE_LIST");
        if (user && user.menuPermission && user.menuPermission.clientList) menuPermission.push("CLIENT_LIST");
        if (user && user.menuPermission && user.menuPermission.clientEmployeeList) menuPermission.push("CLIENT_EMPLOYEE_LIST");
        if (user && user.menuPermission && user.menuPermission.mhEmployeeList) menuPermission.push("MH_EMPLOYEE_LIST");
        if (user && user.menuPermission && user.menuPermission.addMhEmployee) menuPermission.push("ADD_MH_EMPLOYEE");

        userInfo.menuPermission = _.uniq(menuPermission);

        return await successResponseHandler(res, 200, "User info fetch successfully!", "details", userInfo);
    } catch (err) {
        return next(err);
    }
};
...
//pass the client valid inputs to service
export const registerClientUser = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {

        req.body = _.pick(req.body, ["restaurantName", "restaurantAddress", "email", "phoneNumber", "password", "sourceId", "referPersonId", "lat", "long"]);
...
export const registerEmployeeUser = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
...
//pass the employee valid inputs to service
export const updateEmployeeUser = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        req.body = _.pick(req.body, ["id", "firstName", "lastName", "gender", "dateOfBirth", "email", "phoneNumber", "countryName", "presentAddress",
        ...
        return await successResponseHandler(res, 200, "Employee has been updated successfully!");
    } catch (err) {
        console.log("err: ", err);
...
//pass the employee valid inputs to service
export const registerMhEmployeeUser = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {

        req.body = _.pick(req.body, ["name", "email", "phoneNumber", "password", "role", "active", "permissions"]);

        req.body.isMhEmployee = true;

        const user: any = await createMhUser(req);

        return await successResponseHandler(res, 201, "Employee has been registered successfully!");
    } catch (err) {
        return next(err);
    }
};
...
//pass the employee valid inputs to service
export const updatePushNotification = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 201, "Push notification has been updated successfully!");
    } catch (err) {
        return next(err);
    }
};
...
//pass the employee valid inputs to service
export const updateMhEmployeeUser = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {

        req.body = _.pick(req.body, ["id", "name", "email", "phoneNumber", "role", "active", "permissions"]);
...
export const updateUserProfilePicture = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        //Validation check for mandatory fields
        const checkMandatoryFields: any = await UserProfilePicturesUploadRequest(req);
        ...
        req.body = _.pick(req.body, ["id", "profilePicture", "cv", "unlinkArray", "s3BucketUrl"]);

        const user = await updateUser(req);

        const token = await getToken(user);

        return await successResponseHandler(res, 200, "Profile picture updated successfully!", "token", token);
...
export const updateCertificate = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        req.body = _.pick(req.body, ["id", "certificateId", "certificateName", "attachment", "unlinkArray", "s3BucketUrl"]);

        const user = await updateUserCertificateInfo(req);

        return await successResponseHandler(res, 200, "Certificate updated successfully!");
...
export const updateUserEmail = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        if (loggedInUserInfo._id.toString() !== req.body.id) throw new Error("Users are only allowed to change their own Email");
        ...
        return await successResponseHandler(res, 200, "User email updated successfully!", "token", token);
...
export const updateUserPhoneNumber = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {

        //@ts-ignore
        const loggedInUserInfo = req.user;

        if (loggedInUserInfo._id.toString() !== req.body.id) throw new Error("Users are only allowed to change their own phone number");
        ...
        return await successResponseHandler(res, 200, "User phone number updated successfully!", "token", token);
...
export const updateUserPassword = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "User password updated successfully!");
...
export const userForgotPassword = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "We have sent 2 OTP's. Please check your email and phone!");
...
export const userResetPassword = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        req.body = _.pick(body, ["email", "phoneNumber", "password", "confirmPassword", "otpNumber"]);

        const user: any = await resetPassword(req);

        req.body = { action: 'reset-password', name: user.name, email: user.email, otp: body.otpNumber, otpType: "password-change-confirmation", login: config.get<string>("FRONT_END_LOGIN_URL"), subject: config.get<string>("APPLICATION_SHORT_NAME") + " Password Reset" };

        const sentEmail = await addEmailNotificationInfo(req);

        return await successResponseHandler(res, 200, "Your password has been updated successfully! Please login again!");
...
export const userUpdateStatus = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "User info has been updated successfully");
...
export const userReferPersonUpdate = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "Refer person info has been updated successfully");
...
export const clientDiscountUpdate = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "Client discount has been updated successfully");
...
//request is passed to service for updating refer person status
export const updateBankDress = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {

        req.body = _.pick(req.body, ["id", "bankName", "accountNumber", "routingNumber", "dressSize", "additionalOne", "additionalTwo"]);

        const user = await updateUser(req);

        return await successResponseHandler(res, 200, "Bank and dress info has been updated successfully");
...
export const removeUser = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "Your account has been deleted successfully");
...
export const updateUserProfile = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        ...
        return await successResponseHandler(res, 200, "User profile updated successfully!", "token", token);
...
//Passing id and inputs to user service
export const removeCertificate = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
    try {
        req.body = _.pick(req.body, ["id", "certificateId"]);

        const user = await removeEmployeeCertificateInfo(req);

        return await successResponseHandler(res, 200, "Certificate remove successfully!!");
